...
SECRET_KEY = 'django-insecure-mh9v=j&zt=h!9d&jkri#27lb9b!rnvahyey@g^#^y88h$25de0'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'online_store.carts.context_processors.counter',
                'online_store.main.context_processors.show_categories',
            ],
        },
    },
]
